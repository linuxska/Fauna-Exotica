...
<div class='grid_10 push_1 cuenta'>
	...
	<?php echo form_input(array('name' => 'nombre', 'id' => 'nombre', 'maxlength'   => '25', 'size' => '50', 'value' => set_value('nombre'))) ?>
	<?php echo form_label('1º Apellido: ', 'apellido1') ?>
	<?php echo form_input(array('name' => 'apellido1', 'id' => 'apellido1', 'maxlength'   => '30', 'size' => '50', 'value' => set_value('apellido1'))) ?>
	<?php echo form_label('2ºApellido: ', 'apellido2') ?>
	<?php echo form_input(array('name' => 'apellido2', 'id' => 'apellido2', 'maxlength'   => '30', 'size' => '50', 'value' => set_value('apellido2'))) ?>
	<?php echo form_label('Dirección: ', 'direccion') ?>
	<?php echo form_input(array('name' => 'direccion', 'id' => 'direccion', 'maxlength'   => '50', 'size' => '50', 'value' => set_value('direccion'))) ?>	
	...
	<?php echo form_input(array('name' => 'email', 'id' => 'email', 'maxlength'   => '40', 'size' => '50', 'value' => set_value('email'))); ?>
